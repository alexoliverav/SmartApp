...
public class AdapterNewsByCategory extends ArrayAdapter<ItemNewsList> {
    ...
    public AdapterNewsByCategory(Activity act, int resource, List<ItemNewsList> arrayList) {
